...
Zuerst in der Maske Benutzergruppe die gewünschte Gruppe erstellen und einen Token mit '#' am anfang eintraagen. 

Bild 3

Die Gewünschten Tabellen und Prozeduren eintragen


Bild 2

In der maske Verwaltung db User, Benutzer Anlegen und einer Gruppe Zuteilen.
...
image::images/SqlInsertCasUser.png[]
...
image::images/SqlInsertCasUserGroup.png[]
...
image::images/SqlInsertAuthority.png[]
...
image::images/SqlInsertPrivilege.png[]