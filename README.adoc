...
[.float-group]
--
image::https://github.com/minova-afis/aero.minova.core.application.system/actions/workflows/continuous-integration.yml/badge.svg[float="left"]
image::https://img.shields.io/badge/license-EPL%202.0-green[float="left"]
--
