...
insert into xtcasLuUserPrivilegeUserGroup (UserGroupKey, UserPrivilegeKey, LastDate, LastUser, RowLevelSecurity) values ( @UserGroupKey, @UserPrivilegeKey, getDate(), 1, 'support', 1)
