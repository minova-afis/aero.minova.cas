...
Überprüft die Anzahl an Einträgen, welche anhand der übergebenen Table gefunden werden können.

Als Ausgabe wird ein int-Wert zurückgegeben, welcher die Anzahl an Einträgen angibt, welche die übergebenen Eigenschaften besitzen.
