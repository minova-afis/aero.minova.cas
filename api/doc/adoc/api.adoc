...
Konkrete Beispiele sind in einer xref:https://github.com/minova-afis/aero.minova.cas/blob/main/service/aero.minova.cas.api.postman_collection.json#L4#[Postman Collection] gelistet.
