...
** *Wertebereich*: `MSSQL/postgresql/other` Schalter für den Datenbankkontext. Wird für JOOQ verwendet. 
Falls es sich nicht um eine MSSQL oder POSTGRESQL Datenbank handelt, muss statt *other* der dementsprechende Kontext angegeben werden.
