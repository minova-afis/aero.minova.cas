...
Einige Tabellen müssen über JPA installiert werden.
Beim erstmaligen Initialisieren der Datenbank muss in der application.properties folgende Zeile eingefügt werden, damit das weitere Setup funktioniert.
[source]
----
