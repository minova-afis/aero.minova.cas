...
public class XmlDatabaseTable {
                ...
                if (!mymap.containsKey(getPrimaryKeyConstraint().getName())) {
                    ...
                    if (!sqlconstraint.getName().equalsIgnoreCase(getPrimaryKeyConstraint().getName())) {
                        ...
                        if (!isHibernateGeneratedConstraint(sqlconstraint.getName())) {
                            ...
                            // Hibernate-generated constraint exists and is functionally correct
                            // Mark as handled to prevent recreation attempt
    ...
    /**
     * Checks if a constraint was auto-generated by Hibernate/SQL Server.
     * Hibernate uses SQL Server's default naming which includes double underscores.
     * Example: PK__xtcasUse__02E3034FE0755A13
     *
     * Legacy Installer never uses double underscores in constraint names.
     *
     * @param constraintName the name to check
     * @return true if the constraint appears to be Hibernate-generated
     */
    private boolean isHibernateGeneratedConstraint(final String constraintName) {
        return constraintName != null && constraintName.contains("__");
    }
